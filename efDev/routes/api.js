...
router.post('/donation/:id/remove', userController.checkPermission.admin,  donationController.remove);
...
router.get('/contacts/:id', contactController.getDetail);
...
router.get('/files/:role', fileController.getByRole);
